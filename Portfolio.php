      ...
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-3" data-aos="fade-up" data-aos-delay="">Nossos Serviços</h2>
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Buscando sempre a sua comodidade</p>
          </div>
        </div>
        ...
        <div class="row" >
          ...
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="owl-carousel slide-one-item-alt-text">
              <div>
                <h2 class="section-title mb-3">Iluminação via app</h2>
